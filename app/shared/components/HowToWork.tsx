    ...
    <section id="como-funciona" style={{ padding: "5rem 1.5rem", background: "var(--color-cloud)" }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
          ...
          </div>            <h2 className="font-serif font-normal" style={{ fontSize: "clamp(1.875rem, 4vw, 3rem)", lineHeight: 1.1, letterSpacing: "-0.02em", color: "var(--color-navy)", marginBottom: "1rem" }}>
            Do cadastro ao crescimento <em className="italic" style={{ color: "var(--color-cta)" }}>em 4 passos</em>
          </h2>
          <p style={{ fontSize: "1.0625rem", color: "var(--color-stone)", maxWidth: "520px", margin: "0 auto", lineHeight: 1.7 }}>              Configuração simples, resultado rápido. Em menos de uma tarde você já tem sua primeira avaliação rodando.
          </p>
        </div>
          ...
          {STEPS.map((step, i) => (
            <div key={i} style={{ position: "relative" }}>
              ...
              <div className="card" style={{ height: "100%" }}>
                ...
                <h3 style={{ fontSize: "1rem", fontWeight: 600, color: "var(--color-navy)", marginBottom: "0.5rem" }}>                    {step.title}
                </h3>
